...
names = ["一","乙","二","十","丁","厂","七","卜","人","入","八","九","几","儿","了","力","乃","刀","又",
         ...
         "欣","征","往","爬","彼","径","所","舍","金","命","斧","爸","采","受","乳","念","肤",
         ...
         "柱","柿","栏","树","要","咸","威","歪","研","砖","厘","厚","砌","砍","面","耐","耍","牵",
         "轻","鸦","皆","背","战","点","临","览","竖","省","削","尝","是","盼","眨","哄","显","哑",
         "冒","映","星","昨","畏","胃","贵","界","虹","思","虽","品","咽","哗",
         "咱","响","哈","咬","咳","哪","炭","峡","罚","贴","骨","钞","钟","钢","钥","钩","卸","缸",
         ...
         "洋","洲","浑","浓","津","恒","恢","恰","恼","恨","举","觉","宣","室","宫","宪","突","穿",
         ...
         "唇","夏","础","破","原","套","逐","烈","殊","顾","轿","较","顿","毙","致","柴","桌","虑",
         "紧","党","晒","眠","晓","鸭","晃","晌","晕","蚊","哨","哭","恩","唤","啊","唉","罢","峰",
         ...
         "羡","普","尊","道","曾","焰","港","湖","渣","湿","温","渴","滑","湾","渡","游","滋","溉",
         ...
         "懒","壁","避","缴","戴","擦","鞠","藏","霜","霞","瞧","蹈","螺","穗","繁","辫","赢",
